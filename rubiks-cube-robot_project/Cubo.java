...
public class Cubo {
    ...
    public void pontaBranca(){
       ...
       //verifica a peça bottom [0][0] se está em algum lugar da face front(verde 1)
        if(matriz_bottom[0][0] == 1 && matriz_front[2][0] == 3 && matriz_left[2][2] == 5 ) {
            
        }else if(matriz_front[0][0] == 1 && matriz_top[2][0] == 3 && matriz_left[2][2] == 5){
            
           front.turnClock();
           top.turnClock();
           front.turnIClock();
        }else if(matriz_front[0][2]== 1 && matriz_top[2][2] == 5 && matriz_right[0][0] == 3){
           left.turnIClock();
           top.turnIClock();
           left.turnIClock();
           back.turnIClock();
        ...
        }else if(matriz_bottom[0][2] == 1 && matriz_front[2][2] == 5 && matriz_right[0][0] == 3){
           rigth.turnClock();
           top.turnClock180();
           rigth.turnIClock();
           front.turnClock();
        ...
        }else if(matriz_bottom[0][2]== 3 && matriz_front[2][2] == 1 && matriz_right[0][0] == 5){
                 front.turnIClock();
                 top.turnIClock();
                 front.turnClock180();
                 top.turnClock180();
        ...
        }else if(matriz_bottom[0][0]== 5 && matriz_front[2][0] == 1 && matriz_left[2][2] == 3){   
                 front.turnClock();
                 top.turnIClock();
                 front.turnIClock();
                 top.turnIClock();
        ...
        //verifica a peça bottom [0][2] se está em algum lugar da face front(verde 1)
        if(matriz_bottom[0][2] == 1 && matriz_front[2][2] == 3 && matriz_right[2][0] == 4 ) {
            
        }else if(matriz_front[0][0] == 1 && matriz_bottom[2][2] == 4 && matriz_right[2][0] == 3){
            front.turnIClock();
            top.turnIClock();
            front.turnClock();
            top.turnClock();
            ...
            top.turnClock180();
            front.turnClock();
        }else if(matriz_front[2][0] == 3 && matriz_bottom[0][0] == 1 && matriz_left[2][2] == 4){
            front.turnClock();
            top.turnClock();
            front.turnIClock();
            rigth.turnClock();
        ...
        }//verifica a peça bottom [2][2] se está em algum lugar da face front(verde 1)
       if (matriz_bottom[2][2] == 1 && matriz_right[2][2] == 4 && matriz_back[2][0] == 6){
         
        }else if(matriz_front[2][2] == 1 && matriz_right[2][0] == 6 && matriz_front[2][2] == 4){
            rigth.turnClock();
            top.turnIClock();
            rigth.turnIClock();
            back.turnIClock();
            top.turnIClock();
            back.turnClock();
        }else if(matriz_bottom[0][2] == 1 && matriz_right[2][0] == 6 && matriz_front[2][2] == 4){
             rigth.turnClock();
             top.turnClock();
             rigth.turnIClock();
             back.turnIClock();
        ...
        }else if(matriz_front[0][0] == 1 && matriz_left[0][2] == 4 && matriz_top[2][0] == 6){
            front.turnClock();
            back.turnIClock();
            top.turnIClock();
            back.turnClock();
        ...
        }else if(matriz_front[2][0] == 6 && matriz_left[0][2] == 6 && matriz_bottom[0][0] == 1){
               front.turnClock();
               top.turnIClock();
               front.turnIClock();
               rigth.turnIClock();
        ...
        //verifica se a preça bottom [2][0] está em algum lugar da face front(verde 1)
       if(matriz_bottom[2][0] == 1 && matriz_left[2][0] == 5 && matriz_back[2][2] == 6){
           
       }else if(matriz_front[2][0] == 5 && matriz_left[2][2] == 6 && matriz_bottom[0][0] == 1){
           front.turnClock();
           top.turnClock();
           front.turnIClock();
           top.turnClock180();
       ...
       }else if(matriz_front[2][0] == 1 && matriz_left[2][2] == 5 && matriz_bottom[0][0] == 6){
           front.turnClock();
           top.turnClock();
           front.turnIClock();
           top.turnClock180();
           ...
           top.turnClock180();
           back.turnIClock();
       }else if(matriz_front[0][0] == 1 && matriz_left[0][2] == 6 && matriz_top[2][0] == 5){
           back.turnClock();
           top.turnClock();
           back.turnIClock();
           
       }else if(matriz_front[0][2] == 1 && matriz_right[0][0] == 5 && matriz_top[2][2] == 6){
           left.turnClock();
           top.turnClock180();
           left.turnIClock();
           
           
       }else if(matriz_front[2][2] == 6 && matriz_right[2][0] == 5 && matriz_bottom[0][2] == 1){
           left.turnClock180();
           front.turnClock180();
           left.turnClock180();
           front.turnClock180();
       }else if(matriz_front[2][2] == 1 && matriz_right[2][0] == 6 && matriz_bottom[0][2] == 5){
           front.turnIClock();
           top.turnIClock();
           front.turnClock();
           top.turnClock();
