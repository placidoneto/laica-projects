    ...
    for (j = 0; j < 2000; j++) {
        ...
        if (i == 20) {
            ...
            if(strcmp(move, "U2") == 0){
                ...
                backClock180(cubo.left.face, cubo.front.face, cubo.right.face, cubo.top.face, cubo.bottom.face, cubo.back.face);
            } else if(strcmp(move, "B'") == 0){
...
*/
  ...
  //  printf("%s", historyMoviments);
    printf("\n\nMédia de quantidade de movimentos: %d", contMovimentos/100);
    return 0;
}
